...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 28 15:18:15 2022
...
class RealtimePlotWindow:
    ...
    def __init__(self):
        ...
        self.t1 = self.ax1.text(1, 1.1,  str(round(self.fs_av,2)) + "Hz")
        self.t2 = self.ax2.text(1, 1.1,  str(round(self.fs_av,2)) + "Hz")
        ...
        self.f = iir_filter.IIR_filter(self.sos)
    def start(self):
    ...
    def Callback(self, data):
        self.ringbuffer1.append(self.f.filter(data))
        self.ringbuffer2.append(data)
        ...
        if self.f.filter(data) >= 0.5:
                self.board.digital[11].write(1)
        elif self.f.filter(data) < 0.5:
    ...
    def SampleRateChecker(self, data): 
        if (self.t_diff <= 0):
            ...
            if (self.counter % self.arr_size == 0):
                ...
                self.t2.set_text("fs = "+ str(round(self.fs_av,2)) + "Hz")
